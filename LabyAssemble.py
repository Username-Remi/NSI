...
noeudjoueur1=jeu.ListeNoeud[randint(0,9)]#un noeud au hasard pour le joueur
joueur1=Player( 100,float(noeudjoueur1.get_x()),float(noeudjoueur1.get_y()), 2,True ,None, noeudjoueur1)
